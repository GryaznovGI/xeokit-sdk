import { DistanceMeasurement } from 'ct-g-xeokit-distance-measurements-plugin/types/DistanceMeasurement';
import { Plugin, SectionPlane, Viewer } from "ct-g-xeokit-viewer/types";
